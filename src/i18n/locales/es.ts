...
export const es = {
  common: {
    ...
    scripts: {
      ...
      capacityErrorTemplate: 'Capacidad excedida — máximo {cap} bytes (texto actual {len} bytes)',
      imageTooSmallDct: 'Imagen demasiado pequeña — DCT requiere al menos 128×128 px',
  ...
  nav: {
    image: {
      ...
      items: {
        compress: { name: 'Comprimir imagen', desc: 'Compresión inteligente PNG / JPG / WebP' },
        convert: { name: 'Convertir formato', desc: 'Intercambio PNG JPG WebP GIF BMP' },
        'png-to-jpg': { name: 'PNG a JPG', desc: 'Rellena transparencia · archivos más ligeros' },
        'jpg-to-png': { name: 'JPG a PNG', desc: 'Guardado sin pérdida · soporta transparencia' },
        'png-to-webp': { name: 'PNG a WebP', desc: 'Conserva transparencia · archivos más ligeros' },
        'jpg-to-webp': { name: 'JPG a WebP', desc: 'Misma calidad · 25-35% menos tamaño' },
        watermark: { name: 'Marca de agua oculta', desc: 'Insertar / extraer texto invisible' },
        'text-watermark': { name: 'Marca de agua de texto', desc: 'Para DNI · marca anti-fraude' },
      },
    },
    dev: {
      label: 'Herramientas para desarrolladores',
      items: {
        jwt: { name: 'JWT Decodificar/Verificar', desc: 'Analizar, generar, verificar firma' },
        timestamp: { name: 'Convertir Timestamp', desc: 'Unix timestamp ↔ fecha' },
        json: { name: 'Formatear JSON', desc: 'Embellecer / minificar / validar' },
        'code-image': { name: 'Código a Imagen', desc: 'Generar imágenes para compartir código' },
        base64: { name: 'Base64 Codificar/Decodificar', desc: 'Codificación de texto y archivos' },
        uuid: { name: 'Generador UUID', desc: 'Generar identificadores únicos en lote' },
  ...
  quickActions: {
    'png-compress': {
      ...
      tags: ['comprimir PNG', 'pngquant', 'compresión de imagen', 'compress png'],
    },
    'jpg-compress': {
      name: 'Comprimir JPG',
      description: 'Compresión de fotos · 30-45% más ligero',
      tags: ['comprimir JPG', 'comprimir JPEG', 'compresión de imagen', 'compress jpg'],
    },
    'webp-compress': {
      name: 'Comprimir WebP',
    ...
    json: {
      ...
      tags: ['JSON', 'formatear', 'embellecer', 'minificar', 'validar', 'parser'],
    },
    base64: {
      name: 'Base64 Codificar/Decodificar',
      description: 'Convierte texto/archivos a y desde Base64',
      tags: ['Base64', 'codificar', 'decodificar', 'archivo', 'codificar base64', 'decodificar base64'],
    },
    uuid: {
      name: 'Generador UUID',
    ...
    'url-encode': {
      ...
      tags: ['codificar URL', 'decodificar URL', 'encodeURIComponent', 'percent encoding', 'url encode'],
    },
    color: {
      name: 'Conversor de Color',
      description: 'Conversión entre HEX, RGB, HSL',
      tags: ['color', 'conversor de color', 'RGB', 'HEX', 'HSL', 'selector de color'],
    },
    qrcode: {
    ...
    'any-convert': {
      ...
      tags: ['convertir imagen', 'convertir formato de imagen', 'png a jpg', 'jpg a png', 'WebP', 'HEIC', 'BMP', 'GIF'],
    },
    'any-compress': {
    ...
    watermark: {
      ...
      tags: ['marca de agua oculta', 'esteganografía', 'marca de agua', 'LSB', 'DCT'],
    },
    'text-watermark': {
      name: 'Marca de agua de texto',
      description: 'DNI / marca anti-fraude',
      tags: [
        'marca de agua de texto', 'marca de agua de imagen', 'marca de agua de foto', 'añadir marca de agua',
        'marca de agua online', 'marca de agua DNI', 'marca de agua documento', 'marca de agua copyright',
        'marca anti-fraude',
      ],
    },
    'mp4-to-mp3': {
  ...
  toolCategories: {
    image: {
      ...
      tools: {
        compress: { name: 'Comprimir imagen', description: 'Comprime imágenes manteniendo la calidad' },
        convert: { name: 'Convertir formato', description: 'Intercambio PNG JPG WebP GIF BMP' },
        watermark: { name: 'Marca de agua oculta', description: 'Insertar / extraer texto invisible' },
        'text-watermark': { name: 'Marca de agua de texto', description: 'Marca anti-fraude / para documentos' },
      },
    },
    code: {
      ...
      tools: {
        'code-image': { name: 'Código a Imagen', description: 'Convierte código en bonitas imágenes para compartir' },
        json: { name: 'JSON', description: 'Formateo JSON' },
        jwt: { name: 'JWT', description: 'Generar / analizar / verificar' },
        timestamp: { name: 'Timestamp', description: 'Conversión Unix timestamp' },
        base64: { name: 'Base64', description: 'Codificación y decodificación de texto/archivos' },
  ...
  manifest: {
    name: 'WizGo',
    shortName: 'WizGo',
    description: 'Caja de herramientas online gratis: compresión, conversión, JWT, timestamps y más — local, sin subidas',
  },
  pages: {
    home: {
      ...
      heroSubheading: 'Compresión de imagen, conversión, JWT, timestamps · local',
    ...
    convertPair: {
      ...
      fallbackHintTemplate: 'Convierte imágenes {fromFull} a {toFull} online · procesamiento local, sin subidas',
      pairHints: {
        'png-jpg': 'Fondos transparentes rellenos blanco, típicamente 40-80% más ligero, perfecto para web, email y chat.',
        'png-webp': 'WebP conserva transparencia y es 25-50% más ligero que PNG, ampliamente compatible.',
        'png-gif': 'Para plataformas antiguas que solo aceptan GIF.',
        'png-bmp': 'BMP sin compresión para aplicaciones antiguas de Windows.',
        'jpg-png': 'Guardado sin pérdida con transparencia — útil antes de quitar el fondo.',
        'jpg-webp': '25-35% más ligero sin apenas diferencia visible — ideal para sitios con muchas imágenes.',
        'jpg-gif': 'Fotos a GIF para plataformas de chat antiguas.',
        'jpg-bmp': 'Sin pérdida pero muy grande — para imprenta o programas específicos.',
        'webp-png': 'Cuando WebP no se admite, PNG es la alternativa más segura. Transparencia preservada.',
        'webp-jpg': 'Para plataformas sin soporte WebP (foros, editores antiguos).',
        ...
        'gif-jpg': 'Archivos más ligeros, pierde transparencia, solo primer frame — ideal para compartir.',
        'gif-webp': 'GIF estáticos comprimidos como WebP, transparencia preservada.',
        'gif-bmp': 'Solo primer frame, para procesamiento gráfico por lotes.',
        'bmp-png': 'Gran reducción sin pérdida (70%+) — ideal para archivado.',
        'bmp-jpg': 'Máxima compresión para compartir escaneos y capturas por lotes.',
        'bmp-webp': 'Máxima compresión, compatible con navegadores modernos.',
        'bmp-gif': 'Para plataformas antiguas de chat o foros que solo aceptan GIF.',
      },
      upload: {
        dragTemplate: 'Arrastra imágenes {fromLabel} aquí',
        orClick: 'o haz clic para subir (otros formatos de imagen también válidos)',
        sizeHint: 'Hasta 100MB · procesamiento por lotes',
      },
      options: {
        quality: 'Calidad:',
      ...
      schema: {
        descriptionTemplate: 'Convierte imágenes {fromFull} a {toFull} online — procesamiento local, sin subidas.',
      },
    },
    compress: {
      ...
      schema: {
        ...
        description: 'Compresión gratis online de PNG, JPG, WebP — procesamiento local, sin subidas',
        browserReq: 'Navegador moderno con soporte WebAssembly',
      },
      upload: {
    ...
    convert: {
      ...
      schema: {
        ...
        description: 'Intercambio online PNG, JPG, WebP, GIF, BMP — procesamiento local, sin subidas',
      },
      upload: {
        drag: 'Arrastra imágenes aquí',
        orClick: 'o haz clic para subir',
    ...
    about: {
      ...
      schema: {
        ...
        description: 'Stack técnico y política de privacidad de WizGo: cada herramienta se ejecuta en tu navegador — sin subidas.',
        orgDescription:
      ...
      techStack: {
        ...
        image: {
          ...
          body:
            'Módulos WebAssembly construidos en Rust con cuantización de paleta imagequant y el pipeline de optimización jpeg-encoder. Compatible con PNG, JPEG, WebP, GIF, BMP.',
        },
        crypto: {
          title: 'Criptografía y firma',
          body:
            'La decodificación, firma y verificación JWT se ejecutan con la API WebCrypto nativa del navegador. Soporta las familias HS, RS y ES sin dependencias externas.',
        },
        frontend: {
      ...
      privacy: {
        ...
        intro: 'WizGo es una arquitectura 100% frontend; cada archivo se procesa dentro de tu navegador:',
        items: [
      ...
      limits: {
        ...
        intro: 'Por las restricciones del entorno del navegador, WizGo tiene los siguientes límites de uso:',
        items: [
      ...
      credits: {
        ...
        intro: 'WizGo se construye con las siguientes excelentes librerías open source:',
        items: [
          { label: 'imagequant', href: 'https://github.com/ImageOptim/libimagequant', desc: 'Cuantización de paleta PNG' },
          { label: 'lodepng-rust', href: 'https://github.com/kornelski/lodepng-rust', desc: 'Codificador PNG puro en Rust' },
          { label: 'jpeg-encoder', href: 'https://github.com/vstroebel/jpeg-encoder', desc: 'Codificador JPEG en Rust' },
          { label: 'Astro', href: 'https://astro.build', desc: 'Generador moderno de sitios estáticos' },
          { label: 'Geist', href: 'https://vercel.com/font', desc: 'Tipografía de diseño de Vercel' },
        ],
      },
    },
    watermark: {
      ...
      subheading: 'Oculta texto dentro de los píxeles de una imagen o extráelo · procesamiento local',
      schema: {
      ...
      embed: {
        ...
        jpgWarn: 'La salida siempre es PNG — guardar como PNG mantiene la máxima compatibilidad',
      ...
      extract: {
        ...
        resultPlaceholder: 'Pulsa el botón de abajo para extraer la marca de agua',
    ...
    uuid: {
      ...
      h1: 'Generador UUID',
      subheading: 'Genera IDs únicos por lotes · estándar / sin guiones / mayúsculas · local',
      schema: {
        name: 'Generador UUID',
      ...
      info: {
        heading: 'Sobre UUID',
        body:
          'UUID (Identificador Único Universal) es un identificador de 128 bits, normalmente representado como 32 dígitos hexadecimales en 5 grupos. Esta herramienta usa el generador criptográficamente seguro del navegador (crypto.getRandomValues) para producir UUID v4, garantizando una unicidad extremadamente alta — adecuado para claves primarias de base de datos, IDs de sesión, claves API y más.',
      },
    },
    urlEncode: {
      ...
      subheading: 'Codificación de caracteres especiales URL · Unicode · por lotes · local',
      schema: {
        name: 'Codificar/Decodificar URL',
        description: 'Herramienta de codificación/decodificación URL con soporte Unicode y caracteres especiales',
      },
      tabEncode: 'Codificar',
      ...
      encodeMode: {
        ...
        componentHint: 'Completa: codifica todos los caracteres especiales — ideal para valores de parámetros URL',
        uriHint: 'Preservar: mantiene : / ? # & = y otros caracteres reservados — ideal para URLs completas',
      },
      labels: {
      ...
      examples: {
        heading: 'Ejemplos',
        labels: { chinese: 'Chino', space: 'Espacio', ampersand: '&', equals: '=' },
      },
      useCases: {
    ...
    qrcode: {
      ...
      subheading: 'Texto/enlaces a códigos QR · estilos personalizables · PNG/SVG · local',
      schema: {
      ...
      size: 'Tamaño',
      colors: { label: 'Colores', foreground: 'Primer plano', background: 'Fondo' },
      ec: {
      ...
      infoTemplate: 'Longitud: {chars} caract. / {bytes} bytes · Tamaño: {size}x{size}px',
      examples: {
        heading: 'Ejemplos',
        url: 'URL:',
        email: 'Email:',
    ...
    timestamp: {
      ...
      schema: {
        ...
        description: 'Conversor Unix timestamp ↔ fecha con soporte de segundos/milisegundos y zona horaria UTC/local',
      },
      currentTime: {
        label: 'Hora actual',
        pauseBtn: 'Pausar',
      ...
      t2d: {
        ...
        errors: { nan: 'Debe ser un número', oor: 'Número fuera de rango', invalid: 'Timestamp inválido' },
        outputs: { local: 'Hora local', utc: 'Hora UTC', iso: 'ISO 8601', relative: 'Relativo' },
      },
      d2t: {
        label: 'Fecha → Timestamp',
        fillNowBtn: 'Rellenar ahora',
        isoPlaceholder: 'o pega cadena ISO: 2024-01-18T03:30:22Z',
        errors: { invalidDate: 'Fecha inválida', unparseable: 'No se pudo procesar la cadena de fecha' },
        outputs: { sec: 'Unix seg', ms: 'Unix ms', iso: 'ISO 8601 (UTC)' },
      },
      copyBtn: 'Copiar',
      copiedBtn: 'Copiado',
      justNow: 'ahora mismo',
      footerHint: 'Epoch Unix: 1970-01-01 00:00:00 UTC · 10 dígitos para segundos · 13 para milisegundos',
    },
    color: {
      ...
      subheading: 'Conversión de valores HEX, RGB y HSL · vista previa en vivo · local',
      schema: {
        name: 'Conversor de Color',
        description: 'Conversor de valores HEX, RGB y HSL con vista previa en vivo',
      },
      pickerHint: 'Elige un color',
      hex: { label: 'Valor hexadecimal' },
      rgb: { label: 'Valores RGB', r: 'R (rojo)', g: 'G (verde)', b: 'B (azul)' },
      hsl: { label: 'Valores HSL', h: 'H (tono)', s: 'S (saturación)', l: 'L (luminosidad)' },
      copyBtn: 'Copiar',
      copiedBtn: 'Copiado',
      quickColorsLabel: 'Colores rápidos',
      colorNames: {
        black: 'Negro', red: 'Rojo', orange: 'Naranja', amber: 'Ámbar',
        yellowGreen: 'Verde-amarillo', green: 'Verde', cyan: 'Cian', blue: 'Azul',
        indigo: 'Índigo', purple: 'Púrpura', pink: 'Rosa', white: 'Blanco',
      },
    ...
    codeImage: {
      ...
      h1: 'Código a Imagen',
      subheading: 'Imágenes para compartir desde código · multi-lenguaje · multi-tema',
      schema: {
        name: 'Código a Imagen',
        description: 'Convierte código en imágenes bonitas para compartir con soporte multi-lenguaje y multi-tema',
      },
      ...
      tipPrefix: 'Consejo:',
      tipBody: 'El resaltado de sintaxis multi-lenguaje se renderiza en vivo mientras escribes — sin pasos extra.',
    ...
    base64: {
      ...
      subheading: 'Texto/archivo ↔ Base64 · soporta imágenes, texto y binario · local',
      schema: {
        name: 'Base64 Codificar/Decodificar',
        description: 'Conversor texto/archivo ↔ Base64 con soporte de imágenes, texto y binario',
      },
      ...
      errors: {
        encodeFail: 'Error al codificar: el texto contiene caracteres no procesables',
        fileReadFail: 'Error al leer el archivo',
        decodeFail: 'Error al decodificar: cadena Base64 inválida',
        fileTooLargeTemplate: 'Archivo demasiado grande. Máximo 5MB, actual {size}',
      },
    ...
    jwt: {
      ...
      schema: {
        ...
        description: 'Herramienta online JSON Web Token con familias HS/RS/ES — procesamiento local',
      },
    ...
    textWatermark: {
      ...
      subheading: 'Añade marcas de agua de texto a imágenes · anti-fraude, trazabilidad · procesamiento local',
      schema: {
        name: 'Marca de agua de texto en imagen',
        alternateNames: ['marca de agua DNI', 'marca de agua documento', 'marca de agua para trámite', 'marca de agua de texto en imagen'],
        description:
      ...
      howToSchema: {
        ...
        description: 'Añade una marca de agua "solo para uso X" a una imagen en tres pasos para evitar usos indebidos del documento',
        toolName: 'Navegador (Chrome / Safari / Edge)',
        steps: [
          { name: 'Sube la imagen', text: 'Haz clic en el área de subida o arrastra la imagen. Soporta PNG / JPG / WebP. Las imágenes se procesan localmente y nunca se suben.' },
          { name: 'Escribe el texto de marca', text: 'Por ejemplo "Solo para hipoteca del Banco X" o "Solo para trámite de example.com". Indica el uso y destinatario específicos.' },
          { name: 'Ajusta estilo y descarga', text: 'Elige mosaico (resistente al recorte), ajusta color, tamaño, opacidad y rotación, y pulsa descargar PNG.' },
        ],
      },
      faqSchema: {
        items: [
          { question: '¿Es legal añadir marca de agua a un DNI?', answer: 'Sí, y es altamente recomendable. Añadir una marca de agua "solo para uso X" a una copia o escaneo del DNI es una forma eficaz de prevenir el uso indebido, y muchos organismos reguladores han publicado guías similares.' },
          { question: '¿Qué texto debe contener la marca de agua?', answer: 'Incluye tres elementos: propósito + destinatario + fecha. Por ejemplo "Solo para hipoteca del Banco X 2026". Cuanto más específico, más difícil es el uso indebido.' },
          { question: '¿Dónde es más seguro colocar la marca de agua?', answer: 'El modo mosaico es el más seguro — el texto se extiende diagonalmente por toda la imagen y no se puede recortar. Las marcas en esquina se recortan con facilidad. Para documentos importantes, usa mosaico + gris semitransparente.' },
          { question: '¿Se sube mi imagen a algún servidor?', answer: 'No. Todo el procesamiento sucede localmente en tu navegador (Canvas 2D). Las imágenes y el texto nunca salen de tu dispositivo — el servidor solo entrega la página estática.' },
          { question: '¿Se puede eliminar la marca en Photoshop?', answer: 'Las marcas de agua de texto son cambios visibles de píxeles; un usuario experto puede borrarlas en Photoshop, pero lleva tiempo y deja rastros. Para usos cotidianos (reenvíos en chat, hotlinking) disuaden bastante. Para firmas invisibles resistentes a eliminación, usa nuestra herramienta de marca de agua oculta.' },
          { question: '¿La imagen con marca se guarda como JPG o PNG?', answer: 'Esta herramienta exporta PNG (sin pérdida, bordes nítidos). Si el archivo es demasiado grande, pásalo por "Comprimir PNG" para reducirlo aún más.' },
        ],
      },
      imageLabel: 'Imagen',
      dropImage: 'Haz clic o arrastra una imagen aquí',
      ...
      boldLabel: 'Negrita',
      swatches: {
        red: 'Rojo trámite', white: 'Blanco', lightGray: 'Gris claro', midGray: 'Gris medio',
        darkGray: 'Gris oscuro', charcoal: 'Carbón', black: 'Negro',
      },
      ...
      useCases: {
        ...
        items: [
          { title: 'Marca en DNI · anti-fraude', bodyHtml: 'Al solicitar banca, alquiler u onboarding, sueles enviar copias del DNI. Añadir una marca como "Solo para hipoteca del Banco X 2026" evita que el DNI se reutilice para préstamos o apertura de cuentas. Usa <strong>modo mosaico</strong> con 30-50% de opacidad.' },
          { title: 'Licencia / contrato / documento', bodyHtml: 'Al enviar licencias de empresa, permisos de apertura o escaneos de contratos a socios, una marca "solo para uso X" restringe su reutilización. Aplica igual a copias electrónicas de diplomas, carnés y pasaportes.' },
          { title: 'Marca de trámite web', bodyHtml: 'En materiales de trámite web, los documentos de identidad y cartas de autorización necesitan marca. Formato típico: "Solo para trámite de example.com". El mosaico rojo es el estilo recomendado entre los principales proveedores cloud.' },
          { title: 'Anti-robo / protección de copyright', bodyHtml: 'Añadir firma de autor o dominio a fotos, imágenes de producto e ilustraciones antes de publicar en redes reduce drásticamente el robo directo. Usa <strong>esquina</strong> para marcas sutiles de copyright; <strong>mosaico</strong> para una cobertura anti-robo fuerte.' },
        ],
      },
      steps: {
        heading: 'Cómo usar',
      ...
      faq: {
        ...
        items: [
          { q: '¿Es legal añadir marca de agua a un DNI?', aHtml: 'Sí, y es altamente recomendable. Añadir una marca de agua "solo para uso X" a una copia o escaneo del DNI es una forma eficaz de prevenir el uso indebido, y muchos organismos reguladores han publicado guías similares.' },
          { q: '¿Qué texto debe contener la marca de agua?', aHtml: 'Incluye tres elementos: propósito + destinatario + fecha. Por ejemplo "Solo para hipoteca del Banco X 2026". Cuanto más específico, más difícil es el uso indebido. Para trámites web, usa "Solo para trámite de yourdomain.com".' },
          { q: '¿Dónde es más seguro colocar la marca de agua?', aHtml: 'El modo mosaico es el más seguro — el texto se extiende diagonalmente por toda la imagen y no se puede recortar. Las marcas en esquina se recortan con facilidad. Para DNI o tarjetas bancarias, usa mosaico + gris semitransparente para máxima seguridad y legibilidad.' },
          { q: '¿Se sube mi imagen a algún servidor?', aHtml: 'No. Todo el procesamiento sucede localmente en tu navegador (Canvas 2D dibuja los píxeles directamente). Las imágenes y el texto nunca salen de tu dispositivo. Incluso puedes usar esta herramienta sin conexión.' },
          { q: '¿Se puede eliminar la marca en Photoshop?', aHtml: 'Las marcas de agua de texto son cambios visibles de píxeles; un usuario experto puede borrarlas en Photoshop, pero lleva tiempo y deja rastros. Para usos cotidianos (reenvíos en chat, hotlinking) disuaden bastante. Para firmas invisibles resistentes, usa nuestra herramienta <a href="/es/watermark" class="text-[#0072f5] hover:underline">Marca de agua oculta</a>.' },
          { q: '¿Qué pasa si la imagen con marca es demasiado grande?', aHtml: 'Esta herramienta exporta PNG (sin pérdida, bordes nítidos). Si el archivo es demasiado grande para enviar, pásalo por <a href="/es/compress-png" class="text-[#0072f5] hover:underline">Comprimir PNG</a> para reducirlo, o usa <a href="/es/png-to-jpg" class="text-[#0072f5] hover:underline">PNG a JPG</a> para cambiar a un formato más ligero.' },
        ],
      },
    },
    json: {
      ...
      schema: {
        ...
        description: 'Embellece, minifica y valida JSON — procesamiento local, sin subidas',
      },
