...
export class CompressOptions {
     ...
     */
    constructor(quality, max_width, max_height, keep_aspect_ratio) {
        const ret = wasm.compressoptions_new(quality, max_width, max_height, keep_aspect_ratio);
        this.__wbg_ptr = ret >>> 0;
        CompressOptionsFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
if (Symbol.dispose) CompressOptions.prototype[Symbol.dispose] = CompressOptions.prototype.free;
