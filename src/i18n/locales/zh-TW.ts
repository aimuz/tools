...
export const zhTW = {
  ...
  pages: {
    ...
    textWatermark: {
      ...
      description:
        '給圖片加「僅供xx使用」文字浮水印：身分證、駕照、護照、房貸文件、合約防冒用。平鋪/居中/右下角排列。本機處理不上傳照片。',
      h1: '圖片文字浮水印',
      subheading:
        '在身分證、駕照、合約影本上加「僅供 xx 使用」文字浮水印 · 防盜、溯源 · 本機處理不上傳',
      schema: {
        name: '圖片文字浮水印',
        alternateNames: [
          '身分證加浮水印',
        ...
        description:
          '在身分證、駕照、護照、合約等圖片上加可見文字浮水印，用於房貸申請、租屋審核、開戶、合約簽署等情境防冒用、防盜。支援平鋪、居中、右下角三種排列，純瀏覽器本機處理不上傳。',
        featureList: [
          '身分證 / 駕照 / 護照證件浮水印',
          '「僅供 xx 使用」用途限定浮水印',
          '平鋪 / 居中 / 右下角排列',
      ...
      howToSchema: {
        name: '如何給身分證、證件圖片加文字浮水印',
        description: '三步給圖片加上「僅供 xx 使用」文字浮水印，防止證件被冒用',
        ...
        steps: [
          ...
          {
            name: '輸入浮水印文字',
            text: '例如「僅供 xx 銀行 2026 房貸申請使用」、「僅供 xx 租屋審核使用」、「僅供 xx 證券開戶使用」。建議寫明具體用途和接收方名稱。',
          },
          {
            name: '調整樣式並下載',
      ...
      faqSchema: {
        items: [
          {
            question: '給自己的身分證、駕照加浮水印合法嗎？',
            answer:
              '合法。對自己持有的身分證、駕照、護照影本加上「僅供 xx 使用」的文字浮水印，是防止證件被挪作他用的推薦手段，不會影響證件本身的效力。',
          },
          {
            question: '浮水印文字應該寫什麼？',
            answer:
      ...
      replaceImage: '更換圖片',
      textLabel: '浮水印文字',
      textDefault: '僅供 xx 銀行房貸申請使用',
      textPlaceholder: '例如：僅供 xx 銀行房貸申請使用',
      sizeLabel: '字級',
      colorLabel: '顏色',
      boldLabel: '粗體',
      swatches: {
        ...
        items: [
          {
            title: '身分證 / 駕照 · 防冒用',
            bodyHtml:
              '辦理房貸、租屋、轉職身分核實時經常要繳交身分證、駕照影本。加上「僅供 xx 銀行 2026 年房貸辦理使用」這類浮水印，可以避免身分證件被挪作貸款、信用卡開戶等其他用途，降低冒名風險。建議用<strong>平鋪模式</strong>，透明度 30–50%。',
          },
          {
            title: '合約 / 保密協議 / 扣繳憑單',
            bodyHtml:
              '簽好的合約、NDA、扣繳憑單掃描檔寄給合作方或會計師時，加上「僅供 xx 合約審查使用」浮水印可以限制被重複傳閱；薪資單、勞保明細寄給會計也一樣。',
          },
          {
            title: '戶籍謄本 / 存摺影本 / 地址證明',
            bodyHtml:
              '戶籍謄本、存摺封面影本、水電費單等地址證明文件，在寄給仲介或銀行時加上「僅供 xx 租屋審核使用」的浮水印，能大幅降低被挪用到其他交易或開戶的風險。',
          },
          {
            title: '防盜圖 / 版權保護',
            bodyHtml:
      ...
      steps: {
        ...
        itemsHtml: [
          ...
          '<strong>輸入浮水印文字</strong>——寫明具體用途和接收方名稱，例如「僅供 xx 銀行 2026 房貸申請使用」或「僅供 xx 租屋審核 2026/04」，越具體越難被濫用。',
          '<strong>調整樣式</strong>——選擇排列方式（平鋪最防裁切）、顏色（需要顯眼用紅色，低調用灰色）、字級、透明度、旋轉角度，即時預覽結果。',
      ...
      faq: {
        ...
        items: [
          ...
          },
          {
            q: '浮水印文字應該寫什麼？',
            aHtml:
              '建議包含「用途 + 接收方 + 日期」三要素，例如「僅供 xx 銀行 2026 年房貸辦理使用」或「僅供 xx 租屋審核 2026/04」。越具體越不容易被濫用。',
          },
          {
            q: '浮水印加在哪裡最安全？',
            aHtml:
